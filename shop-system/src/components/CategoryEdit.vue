<template>
    <el-form ref="formRef" :model="form" label-width="120px">
        ...
        <el-form-item label="分类图片" v-show="showMore">
            <el-upload ref="uploadRef" class="upload-demo" v-model:file-list="fileList" :action="uploadPictureURL()"
                :headers="{ jwt: token }" :data="{ type: 'category_picture' }" :limit="1" :on-exceed="handleExceed"
